  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#0D1117] bg-opacity-90 backdrop-blur-lg shadow-lg text-white py-4 z-50">
      <div className="container mx-auto flex justify-between items-center px-6">
        ...
        {/* 🌟 Navbar Links */}
        <ul className={`md:flex md:space-x-8 absolute md:relative top-16 md:top-0 left-0 w-full md:w-auto bg-[#0D1117] md:bg-transparent text-center md:text-left p-6 md:p-0 transition-all duration-300 ${
